...
- Quote table names for contraint changes

## [0.0.20](https://forgejo.home.cristiano.cloud/philipcristiano/declare-schema/compare/v0.0.19...v0.0.20) - 2026-06-25

### Fixed

- Handle quoted table names

## [0.0.19](https://forgejo.home.cristiano.cloud/philipcristiano/declare-schema/compare/v0.0.18...v0.0.19) - 2026-06-25

### Fixed

- Set search_path to use the passed in schema

## [0.0.18](https://forgejo.home.cristiano.cloud/philipcristiano/declare-schema/compare/v0.0.17...v0.0.18) - 2026-06-25

### Fixed

- Autodetect schema if not passed in

## [0.0.17](https://forgejo.home.cristiano.cloud/philipcristiano/declare-schema/compare/v0.0.16...v0.0.17) - 2026-06-24

### Fixed

- Don't assume `public` schema by default
...
- Limit changes to current/specified schema

### Other

- *(deps)* update rust docker tag to v1.95
