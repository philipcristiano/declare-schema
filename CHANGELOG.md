...
## [0.0.11](https://github.com/philipcristiano/declare-schema/compare/v0.0.10...v0.0.11) - 2025-03-03

### Fixed

- *(deps)* update rust crate sqlparser to 0.53.0 (#128)

### Other

- *(deps)* lock file maintenance (#153)
- *(deps)* lock file maintenance (#151)
- *(deps)* update rust docker tag to v1.85 (#150)
- *(deps)* lock file maintenance (#148)
- *(deps)* lock file maintenance (#146)
- *(deps)* lock file maintenance (#144)
- *(deps)* lock file maintenance (#141)
- *(deps)* lock file maintenance (#139)
- *(deps)* update rust docker tag to v1.84 (#138)
- *(deps)* lock file maintenance (#136)
- *(deps)* lock file maintenance (#135)
- *(deps)* lock file maintenance (#133)
- *(deps)* lock file maintenance (#131)
- *(deps)* lock file maintenance (#129)
- *(deps)* lock file maintenance (#126)
- *(deps)* lock file maintenance (#124)
- *(deps)* lock file maintenance (#122)
- *(deps)* update rust docker tag to v1.83 (#121)
- *(deps)* lock file maintenance (#119)
- *(deps)* lock file maintenance (#115)
